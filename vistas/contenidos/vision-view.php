...
$codigo=mainModel::encryption("NC1737414511");
...
<!--Contenido-->
    <section class="nosotros">
        ...
        Esta en : <a href="<?php echo SERVERURL; ?>nosotros/">NUESTRO COLEGIO > </a><a href="<?php echo SERVERURL; ?>vision/"><?php echo $rows['NosotrosTitulo']?></a>
        </div>
