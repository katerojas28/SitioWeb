...
$codigo=mainModel::encryption("NC3709228476");
...
<!--Contenido-->
    <section class="nosotros">
        ...
        Esta en : <a href="<?php echo SERVERURL; ?>nosotros/">NUESTRO COLEGIO > </a><a href="<?php echo SERVERURL; ?>fundocente/"><?php echo $rows['NosotrosTitulo']?></a>
        </div>
