...
$codigo=mainModel::encryption("NC0872385195");
...
<!--Contenido-->
    <section class="nosotros">
        ...
        Esta en : <a href="<?php echo SERVERURL; ?>nosotros/">NUESTRO COLEGIO > </a><a href="<?php echo SERVERURL; ?>funrector/"><?php echo $rows['NosotrosTitulo']?></a>
        </div>
