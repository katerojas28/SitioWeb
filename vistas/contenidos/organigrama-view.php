...
$codigo=mainModel::encryption("NC6894727334");
...
<!--Contenido-->
    <section class="nosotros">
        ...
        Esta en : <a href="<?php echo SERVERURL; ?>nosotros/">NUESTRO COLEGIO > </a><a href="<?php echo SERVERURL; ?>organigrama/"><?php echo $rows['NosotrosTitulo']?></a>
        </div>
