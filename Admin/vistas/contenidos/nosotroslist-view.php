		...
		<div class="container-fluid">
			<div class="panel panel-success">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE ITEMS SOBRE NUESTRO COLEGIO</h3>
				</div>
				<div class="panel-body">
					<?php
						$pagina = explode("/",$_GET['views']);
						echo $insNos->paginador_nosotros_controlador($pagina[1], 2,"");
					?>						
				</div>
			</div>
		</div>