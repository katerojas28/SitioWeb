...
<!--formulario-->
	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			...
			if( $_SESSION['codigo_cuenta_ielg']!=$campos['CuentaCodigo']){
				if($_SESSION['tipo_ielg']!="Administrador" || $_SESSION['privilegio_ielg']!="1"){
			...
			<fieldset>
		    		...
		    		<div class="container-fluid">
						...
						<?php
							if($_SESSION['tipo_ielg']=="Administrador" AND $_SESSION['privilegio_ielg']=="1" && $campos['id']!="1"):
						?>
		    		...
		    		<div class="container-fluid">
		    			<div class="row">
		    				<div class="col-xs-12 col-sm-6">
			                    ...
			                    <p class="text-left">
			                        <div class="label label-primary">Nivel 2</div>  Permiso para registro y actualización de material academico
			                    </p>
		    				</div>
		    				<div class="col-xs-12 col-sm-6">
								<div class="radio radio-primary">
...
<div class="full-box cover container-404">
    <div>
        <p class="text-center"> <i class="zmdi zmdi-alert-triangle zmdi-hc-5x"></i></p>
        <h1 class="text-center">LO SENTIMOS</h1>
        <p class="lead text-center">Error de parámetros</p>
    </div>
</div>
